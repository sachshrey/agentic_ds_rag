...
def preprocessing_node(state: AgentState) -> AgentState:
    ...
    # Merge: rule-based for imputation/encoding, LLM only for columns_to_drop
    decision = decision.model_copy(update={"columns_to_drop": llm_drop_decision.columns_to_drop})
